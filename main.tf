...
resource "proxmox_virtual_environment_container" "vault_container" {
  ...
  operating_system {
    template_file_id = proxmox_virtual_environment_download_file.vault_ubuntu_24_04_standard_img.id
    type             = "ubuntu"
  }
...
resource "proxmox_virtual_environment_download_file" "vault_ubuntu_24_04_standard_img" {
  content_type = "vztmpl"
  datastore_id = "local"
  node_name    = "pve01"
  file_name = "vault-ubuntu-24.04-standard.tar.zst"
